    ...
    <Row>
      <Col md="8">
        <h2 data-cy="imagesDetailsHeading">
          <Translate contentKey="rfidh2KafkaApp.images.detail.title">Images</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="guid">
              <Translate contentKey="rfidh2KafkaApp.images.guid">Guid</Translate>
            </span>
          </dt>
          <dd>{imagesEntity.guid}</dd>
          <dt>
            <span id="plate">
              <Translate contentKey="rfidh2KafkaApp.images.plate">Plate</Translate>
            </span>
          </dt>
          <dd>{imagesEntity.plate}</dd>
          <dt>
            <span id="imageLp">
              <Translate contentKey="rfidh2KafkaApp.images.imageLp">Image Lp</Translate>
            </span>
          </dt>
          <dd>
          ...
          <dt>
            <span id="imageThumb">
              <Translate contentKey="rfidh2KafkaApp.images.imageThumb">Image Thumb</Translate>
            </span>
          </dt>
          <dd>
          ...
          <dt>
            <span id="anpr">
              <Translate contentKey="rfidh2KafkaApp.images.anpr">Anpr</Translate>
            </span>
          </dt>
          <dd>{imagesEntity.anpr}</dd>
          <dt>
            <span id="rfid">
              <Translate contentKey="rfidh2KafkaApp.images.rfid">Rfid</Translate>
            </span>
          </dt>
          <dd>{imagesEntity.rfid}</dd>
          <dt>
            <span id="dataStatus">
              <Translate contentKey="rfidh2KafkaApp.images.dataStatus">Data Status</Translate>
            </span>
          </dt>
          <dd>{imagesEntity.dataStatus}</dd>
          <dt>
            <span id="gantry">
              <Translate contentKey="rfidh2KafkaApp.images.gantry">Gantry</Translate>
            </span>
          </dt>
          <dd>{imagesEntity.gantry}</dd>
          <dt>
            <span id="lane">
              <Translate contentKey="rfidh2KafkaApp.images.lane">Lane</Translate>
            </span>
          </dt>
          <dd>{imagesEntity.lane}</dd>
          <dt>
            <span id="kph">
              <Translate contentKey="rfidh2KafkaApp.images.kph">Kph</Translate>
            </span>
          </dt>
          <dd>{imagesEntity.kph}</dd>
          <dt>
            <span id="ambush">
              <Translate contentKey="rfidh2KafkaApp.images.ambush">Ambush</Translate>
            </span>
          </dt>
          <dd>{imagesEntity.ambush}</dd>
          <dt>
            <span id="direction">
              <Translate contentKey="rfidh2KafkaApp.images.direction">Direction</Translate>
            </span>
          </dt>
          <dd>{imagesEntity.direction}</dd>
          <dt>
            <span id="vehicle">
              <Translate contentKey="rfidh2KafkaApp.images.vehicle">Vehicle</Translate>
            </span>
          </dt>
          <dd>{imagesEntity.vehicle}</dd>
          <dt>
            <span id="issue">
              <Translate contentKey="rfidh2KafkaApp.images.issue">Issue</Translate>
            </span>
          </dt>
          <dd>{imagesEntity.issue}</dd>
          <dt>
            <span id="status">
              <Translate contentKey="rfidh2KafkaApp.images.status">Status</Translate>
            </span>
          </dt>
