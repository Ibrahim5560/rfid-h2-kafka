...
@RestController
@RequestMapping("/api/rfidh-2-kafka-kafka")
public class Rfidh2KafkaKafkaResource {

    private final Logger log = LoggerFactory.getLogger(Rfidh2KafkaKafkaResource.class);
    ...
    public Rfidh2KafkaKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
